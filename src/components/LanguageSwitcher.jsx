    ...
    return (
        <div className="relative inline-block text-left">
            <button
                ...
                className="flex items-center px-3 py-1 rounded text-sm hover:bg-gray-100"
            >
                <img src={current.flag} alt={current.label} className="w-5 h-5 mr-2 inline-block align-middle" />
                {current.label}
            ...
            {open && (
                <ul className="absolute mt-2 w-full bg-white border border-gray-300 rounded shadow text-sm z-50">
                    {languages.map((lang) => (
                        <li key={lang.code}>
                            <button
                            ...
                            >
                                <img src={lang.flag} alt={lang.label} className="w-5 h-5 mr-2 inline-block align-middle" />
                                {lang.label}
                            </button>
                        </li>
                    ))}
