...
const VideoSection = () => {
    ...
    return (
        <section className="max-w-5xl mx-auto px-4 py-20 text-center">
            ...
            {/* Subtext */}
            <p className="text-[#657080] max-w-2xl mx-auto mt-4 text-base md:text-lg leading-relaxed">
                {t("revolution.description")}
            </p>

            {/* Video Embed */}
            <div className="relative overflow-hidden rounded-2xl shadow-md mt-10 mx-auto w-full max-w-3xl aspect-video">
                <iframe
